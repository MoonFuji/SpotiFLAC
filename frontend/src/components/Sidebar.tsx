      ...
      <div className="flex flex-col gap-2 flex-1">
        ...
        <Tooltip delayDuration={0}>
          <TooltipTrigger asChild>
            <Button
              variant={
                currentPage === "quality-upgrade" ? "secondary" : "ghost"
              }
              size="icon"
              className={`h-10 w-10 ${currentPage === "quality-upgrade" ? "bg-primary/10 text-primary hover:bg-primary/20" : "hover:bg-primary/10 hover:text-primary"}`}
              onClick={() => onPageChange("quality-upgrade")}
            >
        ...
        <Tooltip delayDuration={0}>
          <TooltipTrigger asChild>
            <Button
              variant={currentPage === "for-later" ? "secondary" : "ghost"}
              size="icon"
              className={`h-10 w-10 ${currentPage === "for-later" ? "bg-primary/10 text-primary hover:bg-primary/20" : "hover:bg-primary/10 hover:text-primary"}`}
              onClick={() => onPageChange("for-later")}
            >
              <Bookmark size={20} />
            </Button>
          </TooltipTrigger>
