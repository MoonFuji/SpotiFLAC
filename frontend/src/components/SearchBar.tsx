...
interface SearchBarProps {
  ...
  /** When set (e.g. from Quality Upgrade), prefill search and switch to search mode */
  initialSearchQuery?: string | null;
  /** Called after initialSearchQuery has been applied so parent can clear it */
...
export const SearchBar = forwardRef<HTMLInputElement, SearchBarProps>(
  function SearchBar(
    ...
    const [searchResults, setSearchResults] =
      useState<backend.SearchResponse | null>(null);
    ...
    // Apply initial search query when navigating from Quality Upgrade (or similar)
    useEffect(() => {
