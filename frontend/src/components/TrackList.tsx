...
import { Download, CheckCircle, XCircle, FileCheck, FileText, Globe, ImageDown, Bookmark, ExternalLink } from "lucide-react";
            ...
            {paginatedTracks.map((track, index) => (<tr key={index} className="border-b transition-colors hover:bg-muted/50">
              ...
              <td className="p-4 align-middle text-center">
                <div className="flex items-center justify-center gap-1">
                  ...
                  {track.spotify_id && track.external_urls && (<Tooltip>
                    <TooltipTrigger asChild>
                      <Button onClick={() => openInSpotify(track.spotify_id!, track.external_urls)} size="sm" variant="outline">
                  ...
                  {onSaveForLater && track.spotify_id && track.external_urls && (<Tooltip>
                    <TooltipTrigger asChild>
                      <Button onClick={() => onSaveForLater(track)} size="sm" variant="outline">
