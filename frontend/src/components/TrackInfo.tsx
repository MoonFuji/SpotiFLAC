...
import { Download, FolderOpen, CheckCircle, XCircle, FileText, FileCheck, Globe, ImageDown, Bookmark, ExternalLink } from "lucide-react";
      ...
      <div className="flex gap-6 items-start">
        ...
        <div className="flex-1 space-y-4 min-w-0">
          ...
          {track.isrc && (<div className="flex gap-2 flex-wrap">
            ...
            {track.spotify_id && spotifyUrl && (<Tooltip>
              <TooltipTrigger asChild>
                <Button onClick={() => openInSpotify(track.spotify_id!, spotifyUrl)} variant="outline">
                  <ExternalLink className="h-4 w-4" />
                </Button>
              </TooltipTrigger>
              <TooltipContent>
                <p>Open in Spotify to check version</p>
              </TooltipContent>
            </Tooltip>)}
            {onSaveForLater && (<Tooltip>
              <TooltipTrigger asChild>
              ...
              <TooltipContent>
                <p>Save for later (e.g. when on mobile data)</p>
              </TooltipContent>
            </Tooltip>)}
